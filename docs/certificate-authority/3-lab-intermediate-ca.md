...
```
pkcs11-tool -l --keypairgen --key-type EC:secp384r1 --label lab-intermediate
```
...
```
openssl req -config create_lab_intermediate_csr.ini -engine pkcs11 -keyform engine -key <lab-intermediate-private-key-id-from-hsm> -new -sha512 -out ../intermediate/csr/intermediate.csr
```
...
```
openssl req -text -noout -verify -in ../intermediate/lab/csr/intermediate.csr
```
